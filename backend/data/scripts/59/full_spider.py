...
# 配置
URL = "https://whfgw.wuhu.gov.cn/content/column/6788808?pageIndex=1"
ENGINE = "requests"
MAX_PAGES = 2
INTERVAL = 2
DETAIL_LINK_XPATH = "//ul[contains(@class,'doc_list')]/li/a[contains(@class,'left')]/@href"
...
CONFIGURED_FIELDS = {"title": "//h1[@class='wztit']/text()", "content": "//div[@class='wzcon j-fontContent clearfix']//text()", "chubanriqi": "//span[@class='fbsj']/text()", "keyword": "//meta[@name='Keywords']/@content", "kanming": "//span[@class='res']/text()"}
...
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_59_17bbdf27"
TASK_NAME = "芜湖"
LLM_CONFIG_ID = 1
...
_fields_json = """{"title": "//h1[@class='wztit']/text()", "content": "//div[@class='wzcon j-fontContent clearfix']//text()", "chubanriqi": "//span[@class='fbsj']/text()", "keyword": "//meta[@name='Keywords']/@content", "kanming": "//span[@class='res']/text()"}"""
