...
MAX_PAGES = 2
INTERVAL = 2
DETAIL_LINK_XPATH = "//a[@class='hds-content-item-heading']"
PAGINATION_TYPE = "js_click"
NEXT_XPATH = "//nav[contains(@class,'hds-pagination--content-lists')]"
PAGE_URL_TEMPLATE = ""
PAGE_COUNT = 0
LLM_CONFIG_ID = 1

# 任务配置的字段（专业采集配置的 fields 优先使用）
CONFIGURED_FIELDS = {"title": "//div[@id='single-blog-1226393']/h1/text()", "content": "//div[@id='single-blog-1226393']/h1/following-sibling::*[not(self::div[contains(@class,'mobile-credits')] or self::footer)]//text()", "chubanriqi": "//div[@class='post-date']/time/text()", "zuozhe": "//p[@class='author-name']/text()", "keyword": "//nav[@id='categories-sidebar']/a/text()", "kanming": "//div[@id='blog-name-header']//h2/a/text()"}
...
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_60_b93df998"
TASK_NAME = "nasa"
LLM_CONFIG_ID = 1
...
_fields_json = """{"title": "//div[@id='single-blog-1226393']/h1/text()", "content": "//div[@id='single-blog-1226393']/h1/following-sibling::*[not(self::div[contains(@class,'mobile-credits')] or self::footer)]//text()", "chubanriqi": "//div[@class='post-date']/time/text()", "zuozhe": "//p[@class='author-name']/text()", "keyword": "//nav[@id='categories-sidebar']/a/text()", "kanming": "//div[@id='blog-name-header']//h2/a/text()"}"""
