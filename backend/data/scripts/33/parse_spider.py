...
def parse():
    ...
    for record_id, url in urls:
        try:
            ...
            try:
                vals = tree.xpath("//h2[@id='ivs_title']/text()")
                texts = []
                for v in vals:
                    if isinstance(v, str):
                        t = v.strip()
                ...
                data["title"] = ""
            try:
                vals = tree.xpath("//div[@id='ivs_content']/p[1]/text()")
                texts = []
                for v in vals:
                    if isinstance(v, str):
                        t = v.strip()
            ...
            try:
                ...
                data["content"] = ""
            try:
                vals = tree.xpath("//*[@id='ivs_date']/span/text()")
                texts = []
                for v in vals:
                    if isinstance(v, str):
                        t = v.strip()
            ...
            try:
                ...
                data["keyword"] = ""
            try:
                vals = tree.xpath("//*[@id='ivs_date']/text()[1]")
                texts = []
                for v in vals:
                    if isinstance(v, str):
                        t = v.strip()
