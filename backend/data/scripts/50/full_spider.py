...
MAX_PAGES = 2
INTERVAL = 2
DETAIL_LINK_XPATH = "//div[contains(@class,'hds-content-item')]//a[contains(@class,'hds-content-item-heading')]/@href"
...
CONFIGURED_FIELDS = {"title": "//div[contains(@class,'single-blog-content')]/h1/text()", "content": "//div[contains(@class,'single-blog-content')]/p//text()", "chubanriqi": "//div[contains(@class,'post-date')]/time/text()", "zuozhe": "//div[contains(@class,'post-author')]//p[@class='author-name']/text()", "keyword": "//meta[@name='keywords']/@content", "kanming": "//div[@id='blog-name-header']//h2/a/text()"}
...
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_50_b93df998"
TASK_NAME = "nasa"
            ...
            try:
                ...
                if has_data:
                    ...
                    if data.get("content"):
                        ...
                        log(f"title有值但content为空，重新分析: {url[:60]}")
                else:
