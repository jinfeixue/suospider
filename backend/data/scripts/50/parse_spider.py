...
_fields_json = """{"title": "//div[contains(@class,'single-blog-content')]/h1/text()", "zuozhe": "//div[contains(@class,'post-author')]//p[@class='author-name']/text()", "content": "//div[contains(@class,'single-blog-content')]/p//text()", "kanming": "//div[@id='blog-name-header']//h2/a/text()", "keyword": "//meta[@name='keywords']/@content", "chubanriqi": "//div[contains(@class,'post-date')]/time/text()"}"""
