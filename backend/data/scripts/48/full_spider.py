...
CONFIGURED_FIELDS = {"title": "//div[contains(@class, 'single-blog-content')]/h1/text()", "zuozhe": "//meta[@name='parsely-author']/@content", "content": "//div[contains(@class, 'single-blog-content')]/p//text()", "kanming": "//div[@id='blog-name-header']//h2/a/text()", "keyword": "//meta[@name='keywords']/@content", "chubanriqi": "//meta[@name='searchgov_custom5']/@content"}
...
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_48_b93df998"
TASK_NAME = "nasa"
