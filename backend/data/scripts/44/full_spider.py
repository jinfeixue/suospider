...
CONFIGURED_FIELDS = {"title": "//h1/text()", "content": "//div[@id='single-blog-1004374' and contains(@class, 'single-blog-content')]/div[not(@class)]//text()", "chubanriqi": "//time/@datetime", "zuozhe": "//div[contains(@class, 'blog-sidebar')]//p[contains(@class, 'author-name')]/text()", "keyword": "//meta[@name='keywords']/@content", "kanming": "//h2/a/text()"}
...
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_44_b93df998"
TASK_NAME = "usa_nasa"
