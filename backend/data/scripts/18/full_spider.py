...
MAX_PAGES = 2
INTERVAL = 2
DETAIL_LINK_XPATH = "//div[contains(@class, 'views-row')]//h3[contains(@class, 'news-updates-title')]/a/@href"
NEXT_XPATH = "//nav[contains(@class, 'usa-pagination')]//a[contains(@class, 'usa-pagination__next-page')]/@href"
...
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_18_9b4d08d4"
