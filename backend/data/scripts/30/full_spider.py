...
NEXT_XPATH = "//div[contains(@class,'pagination')]"
PAGE_URL_TEMPLATE = ""
PAGE_COUNT = 0
LLM_CONFIG_ID = 1

# 任务配置的字段（专业采集配置的 fields 优先使用）
CONFIGURED_FIELDS = {"title": "//h1[@class='wztit']/text()", "content": "//h1[@class='wztit']/following-sibling::div[@class='wzcon j-fontContent clearfix']//text()", "kanming": "//span[@class='res']/text()", "keyword": "//meta[@name='Keywords']/@content", "chubanriqi": "//span[@class='fbsj']/text()"}
...
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_30_f9baee61"
