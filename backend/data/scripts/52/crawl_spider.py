...
MAX_PAGES = 2
INTERVAL = 2
DETAIL_LINK_XPATH = "//ul[contains(@class, 'tadaty-list')]/li/a"
...
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_52_a32f16a3"
TASK_NAME = "上海要闻"
LLM_CONFIG_ID = 1

# 字段配置（JSON字符串，需要解析为字典）
_fields_json = """{"title": "//h2[@id='ivs_title']/text()[1]", "content": "//div[@id='ivs_content']//text()", "chubanriqi": "//small[@id='ivs_date']/text()[1]", "zuozhe": "//p[contains(text(),'记者')][1]/text()", "keyword": "/html/head/meta[@name='keywords']/@content", "kanming": "//small[@id='ivs_date']/span/text()"}"""
