...
# 配置
URL = "https://fas.org/publications-archive/?s=&pt=press-release"
ENGINE = "requests"
MAX_PAGES = 1
INTERVAL = 1
DETAIL_LINK_XPATH = '//div[@class="posts-archive__grid"]/a/@href'
NEXT_XPATH = ""
PAGE_URL_TEMPLATE = "https://fas.org/publications-archive/page/{page}/?s&pt=press-release"
LLM_CONFIG_ID = None

# 任务配置的字段（专业采集配置的 fields 优先使用）
CONFIGURED_FIELDS = {"title": {"type": "xpath", "xpath": "//h1/text()", "value": ""}, "field1": {"type": "constant", "value": "测试1", "xpath": ""}, "field8": {"type": "constant", "value": "美国联合会", "xpath": ""}, "content": {"type": "xpath", "xpath": "//main//header/following::p//text()", "value": ""}, "chubanriqi": {"type": "xpath", "xpath": "//div[@class=\"single-post__title-area-data\"]/span[1]/text()", "value": ""}, "field2": {"type": "constant", "value": "测试2", "xpath": ""}}

DB_HOST = "192.168.1.191"
DB_PORT = 3308
DB_NAME = "ai_spider_260609"
DB_TABLE = "crawler_feachdata"
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_29_a5a53fd1"
