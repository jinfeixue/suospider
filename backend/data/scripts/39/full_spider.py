...
# 配置
URL = "nasa.gov/news/recently-published/"
ENGINE = "requests"
MAX_PAGES = 2
INTERVAL = 2
DETAIL_LINK_XPATH = "//div[contains(@class,'hds-content-items-list')]//div[contains(@class,'hds-content-item')]//a[contains(@class,'hds-content-item-heading')]/@href"
...
CONFIGURED_FIELDS = {"title": "//div[contains(@class,'single-blog-content')]/h1/text()", "content": "//div[contains(@class,'single-blog-content')]/*[not(self::h1) and not(contains(@class,'mobile-credits'))]//text()", "chubanriqi": "(//time[@datetime])[1]/text()", "zuozhe": "//p[@class='author-name']/text()", "keyword": "//meta[@name='keywords']/@content", "kanming": "//div[@id='blog-name-header']//h2/text()"}
...
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_39_d94f3900"
