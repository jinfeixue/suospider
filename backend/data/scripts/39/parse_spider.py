...
def parse():
    ...
    for record_id, url in urls:
        try:
            ...
            try:
                vals = tree.xpath("//div[contains(@class,'single-blog-content')]/h1/text()")
                texts = []
                for v in vals:
                    if isinstance(v, str):
                        t = v.strip()
                ...
                data["title"] = ""
            try:
                vals = tree.xpath("//div[contains(@class,'single-blog-content')]/*[not(self::h1) and not(contains(@class,'mobile-credits'))]//text()")
                texts = []
                for v in vals:
                    if isinstance(v, str):
                        t = v.strip()
                ...
                data["content"] = ""
            try:
                vals = tree.xpath("(//time[@datetime])[1]/text()")
                texts = []
                for v in vals:
                    if isinstance(v, str):
                        t = v.strip()
                ...
                data["chubanriqi"] = ""
            try:
                vals = tree.xpath("//p[@class='author-name']/text()")
                texts = []
                for v in vals:
                    if isinstance(v, str):
                        t = v.strip()
                ...
                data["zuozhe"] = ""
            try:
                vals = tree.xpath("//meta[@name='keywords']/@content")
                texts = []
                for v in vals:
                    if isinstance(v, str):
                        t = v.strip()
