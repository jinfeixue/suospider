...
CONFIGURED_FIELDS = {"title": "//article//h1/text()", "content": "//div[@itemprop='articleBody']/p//text()", "chubanriqi": "//div[@itemprop='datePublished']/time/text()", "zuozhe": "//p[@itemprop='author']/text()", "keyword": "//meta[@name='keywords']/@content", "kanming": "//div[@id='blog-name-header']//h2/a/text()"}
...
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_47_b93df998"
TASK_NAME = "usa_nasa"
