...
CONFIGURED_FIELDS = {"title": "//article[@itemtype='http://schema.org/Article']//h1/text()", "content": "//article[@itemtype='http://schema.org/Article']//div[contains(@class,'single-blog-content')]/p//text()", "chubanriqi": "//article[@itemtype='http://schema.org/Article']//time[@itemprop='datePublished']/text()", "zuozhe": "//article[@itemtype='http://schema.org/Article']//p[@itemprop='author']/text()", "keyword": "//nav[@id='categories-sidebar']/a/text()", "kanming": "//div[@id='blog-name-header']//h2/text()"}
