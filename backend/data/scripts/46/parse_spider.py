    ...
    for record_id, url in urls:
        try:
            ...
            try:
                ...
                data["title"] = ""
            try:
                vals = tree.xpath("//div[@itemprop='articleBody']//text()")
                texts = []
                for v in vals:
                    if isinstance(v, str):
                        t = v.strip()
                ...
                data["content"] = ""
            try:
                vals = tree.xpath("//div[@id='blog-post-meta-sidebar']//div[contains(@class, 'post-date')]/time/text()")
                texts = []
                for v in vals:
                    if isinstance(v, str):
                        t = v.strip()
                ...
                data["chubanriqi"] = ""
            try:
                vals = tree.xpath("//div[@id='blog-post-meta-sidebar']//p[@class='author-name']/text()")
                texts = []
                for v in vals:
                    if isinstance(v, str):
                        t = v.strip()
            ...
            try:
                ...
                data["keyword"] = ""
            try:
                vals = tree.xpath("//div[@id='blog-name-header']/descendant::h2/text()")
                texts = []
                for v in vals:
                    if isinstance(v, str):
                        t = v.strip()
