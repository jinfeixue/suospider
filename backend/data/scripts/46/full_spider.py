...
CONFIGURED_FIELDS = {"title": "//div[contains(@class, 'single-blog-content')]/h1/text()", "content": "//div[@itemprop='articleBody']//text()", "chubanriqi": "//div[@id='blog-post-meta-sidebar']//div[contains(@class, 'post-date')]/time/text()", "zuozhe": "//div[@id='blog-post-meta-sidebar']//p[@class='author-name']/text()", "keyword": "//meta[@name='keywords']/@content", "kanming": "//div[@id='blog-name-header']/descendant::h2/text()"}
