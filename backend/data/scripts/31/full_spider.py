...
CONFIGURED_FIELDS = {"title": "//h1[@class='wztit']/text()", "content": "//div[@class='wzcon j-fontContent clearfix']//text()", "kanming": "//span[@class='res']/text()", "chubanriqi": "//span[@class='fbsj']/text()"}
