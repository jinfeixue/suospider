...
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_27_9b4d08d4"
...
def parse():
    ...
    for record_id, url in urls:
        ...
        try:
            ...
            data["title"] = ""
        try:
            vals = tree.xpath("//article//div[contains(@class, 'field--name-body')]//text()")
            data["content"] = vals[0].strip() if vals else ""
        except:
            data["content"] = ""
        try:
            vals = tree.xpath("//ol[contains(@class, 'uswds-breadcrumbs')]/li[3]/a/text()")
