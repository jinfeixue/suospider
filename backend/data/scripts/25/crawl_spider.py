...
MAX_PAGES = 2
INTERVAL = 2
DETAIL_LINK_XPATH = "//div[contains(@class, 'news-updates')]/h3[contains(@class, 'news-updates-title')]/span/a/@href"
NEXT_XPATH = "//a[contains(@class, 'pagination__next-page')]/@href"
PAGE_URL_TEMPLATE = "?page={page_number}"
