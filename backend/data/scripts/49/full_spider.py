...
MAX_PAGES = 2
INTERVAL = 2
DETAIL_LINK_XPATH = "//div[contains(@class,'hds-content-items-list')]//a[contains(@class,'hds-content-item-heading')]/@href"
...
CONFIGURED_FIELDS = {"title": "//h1/text()", "content": "//div[contains(@class,'single-blog-content')]/p//text()", "chubanriqi": "//time[@itemprop='datePublished']/text()", "zuozhe": "//p[@class='author-name']/text()", "keyword": "//meta[@name='keywords']/@content", "kanming": "//meta[@property='og:site_name']/@content"}
...
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_49_b93df998"
TASK_NAME = "nasa"
