...
CONFIGURED_FIELDS = {"title": "//h1[contains(@class, 'margin-bottom-4')]/text()", "content": "//div[contains(@class, 'single-blog-content')]/p//text()", "chubanriqi": "(//div[contains(@class, 'blog-sidebar')]//time/text())[1]", "zuozhe": "//p[@itemprop='author']/text()", "keyword": "//meta[@name='keywords']/@content", "kanming": "//div[@id='blog-name-header']//h2/a/text()"}
...
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_40_d94f3900"
