...
CONFIGURED_FIELDS = {"title": "//h2[@id='ivs_title']/text()[1]", "content": "//div[@id='ivs_content']//text()", "chubanriqi": "//small[@id='ivs_date']/text()", "zuozhe": "//div[@id='ivs_content']/p[contains(text(),'记者')]/text()", "keyword": "//meta[@name='keywords']/@content", "kanming": "//small[@id='ivs_date']/span/text()"}
...
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_35_a32f16a3"
