...
CONFIGURED_FIELDS = {"title": "//h1/text()", "zuozhe": "(//p[@itemprop='author'])[1]/text()", "content": "//div[contains(@class, 'single-blog-content')]/p//text()", "kanming": "//div[@id='blog-name-header']//h2/a/text()", "keyword": "//meta[@name='keywords']/@content", "chubanriqi": "(//time[@itemprop='datePublished'])[1]/text()"}
...
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_42_b93df998"
TASK_NAME = "usn_nasa"
