...
MAX_PAGES = 2
INTERVAL = 2
DETAIL_LINK_XPATH = "//ul[@class='doc_list list-6788808']/li/a/@href"
PAGINATION_TYPE = "next_button"
NEXT_XPATH = '//a[contains(text(),"下一页")]'
PAGE_URL_TEMPLATE = ""
PAGE_COUNT = 0
LLM_CONFIG_ID = 1

# 任务配置的字段（专业采集配置的 fields 优先使用）
CONFIGURED_FIELDS = {"title": "//h1[@class=\"wztit\"]/text()", "content": "//div[contains(@class, 'wzcon')]//text()", "chubanriqi": "//span[@class=\"fbsj\"]/text()", "keyword": "//meta[@name=\"Keywords\"]/@content", "kanming": "//span[@class=\"res\"]/text()"}
...
DB_USER = "root"
DB_PASSWORD = "123456"
SPIDER_NAME = "spider_36_f9baee61"
